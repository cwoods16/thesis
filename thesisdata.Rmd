...
chisq.test(sprnullweighted$Transactions, sprnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(sprnullweighted$Purchases, sprnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(fallnullweighted$Transactions, fallnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(fallnullweighted$Purchases, fallnullconsistentprob$Probability, simulate.p.value = TRUE)

```

```{r}
#Spring Transactions Chi Squared
chisq.test(springtransactions$Transactions, sprnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(springtransactions$Transactions, sprnullweightedprob$Probability, simulate.p.value = TRUE)
```

```{r}
#Spring Purchases Chi Squared
chisq.test(springpurchases$TotalPurch, sprnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(springpurchases$TotalPurch, sprnullweightedprob$Probability, simulate.p.value = TRUE)
```

```{r}
#Fall Transactions Chi Squared
chisq.test(falltransactions$Transactions, fallnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(falltransactions$Transactions, fallnullweightedprob$Probability, simulate.p.value = TRUE)
```

```{r}
#Fall Purchases Chi Squared
chisq.test(fallpurchases$TotalPurch, fallnullconsistentprob$Probability, simulate.p.value = TRUE)
chisq.test(fallpurchases$TotalPurch, fallnullweightedprob$Probability, simulate.p.value = TRUE)
```
