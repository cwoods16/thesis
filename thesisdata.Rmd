...
chisq.test(sprnullweighted$Transactions, sprnullconsistent$Transactions, simulate.p.value = FALSE)
chisq.test(sprnullweighted$Purchases, sprnullconsistent$Purchases, simulate.p.value = FALSE)
chisq.test(fallnullweighted$Transactions, fallnullconsistent$Transactions, simulate.p.value = FALSE)
chisq.test(fallnullweighted$Purchases, fallnullconsistent$Purchases, simulate.p.value = FALSE)

```

```{r}
#Spring Transactions Chi Squared
chisq.test(springtransactions$Transactions, sprnullconsistent$Transactions, simulate.p.value = FALSE)
chisq.test(springtransactions$Transactions, sprnullweighted$Transactions, simulate.p.value = FALSE)

springtransactions$Transactions
sprnullconsistent$Transactions
sprnullweighted$Transactions
```

```{r}
#Spring Purchases Chi Squared
chisq.test(springpurchases$TotalPurch, sprnullconsistent$Purchases, simulate.p.value = FALSE)
chisq.test(springpurchases$TotalPurch, sprnullweighted$Purchases, simulate.p.value = FALSE)

springpurchases$TotalPurch
sprnullconsistent$Purchases
sprnullweighted$Purchases
```

```{r}
#Fall Transactions Chi Squared
chisq.test(falltransactions$Transactions, fallnullconsistent$Transactions, simulate.p.value = FALSE)
chisq.test(falltransactions$Transactions, fallnullweighted$Transactions, simulate.p.value = FALSE)
```

```{r}
#Fall Purchases Chi Squared
chisq.test(fallpurchases$TotalPurch, fallnullconsistent$Purchases, simulate.p.value = FALSE)
chisq.test(fallpurchases$TotalPurch, fallnullweighted$Purchases, simulate.p.value = FALSE)
```
